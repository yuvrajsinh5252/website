  ...
  return (
    <MaxWidthWrapper className="z-50 relative">
      <div className="items-center fixed flex justify-start w-[inherit] h-fit mt-14">
        <nav className="flex left-1/2 -translate-x-1/2 fixed max-auto items-center justify-center w-fit h-9 rounded-2xl bg-gray-600/20 transition-transform duration-200 ease-linear outline-none border-2 border-gray-300/20 border-opacity-20 backdrop-filter backdrop-blur-xl gap-2 p-7">
          <div
            id="active-bg"
